 ...
 */
public class AllocationMonthsAdapter extends ArrayAdapter<AllocationDetails> {
    private List<AllocationDetails> mAllocationDetailsList = null;
    private Context mContext;
    private LayoutInflater inflater;

    public AllocationMonthsAdapter(Context context, int resource, List<AllocationDetails> objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        vT_apl_spinnerText.setText(allocationDetails.getmAllocationMonth());
        return convertView;
    }
